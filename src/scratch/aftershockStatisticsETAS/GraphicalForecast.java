...
//	}
	...
	public void writeHTML(File outputFile){
		...
		headString.append(""
				...
				+"            td {padding:0px}\n"
				+"            \n"
				+" 			  .imageButton {color:#000000;background-color:#eeeeee; border:1px solid black; width:200px; padding:2px; font-size:10pt;}\n"
	            +"			  .durButton {color:#000000; background-color:#eeeeee; border:1px solid black; width:100px; padding:2px; font-size:10pt;}\n"
	            +" 			  .activeImageButton {color:#dd0000; background-color:#ffeeee; border:1px solid black; width:200px; padding:2px; font-size:10pt;}\n"
				...
				+"            .forecastValue { font-size:10px; border:0px solid gray; border-collapse:collapse; text-align:center; margin:0; vertical-align:bottom; color:#666666;}\n"
				+"            .forecastKey { font-size:10px; border:0px solid gray; border-collapse:collapse; text-align:center; margin:0; vertical-align:bottom; padding:0px}\n"
				...
				+"		\n"
				+"		function checkLogo(){\n"
				+"			checkImageExists(\"logo.png\", function(existsImage) {\n"
				+"					if (existsImage == true) {\n"
				+"						//do nothing\n"
				+"					} else {\n"
				+"						document.getElementById(\"logo\").src = \"USAID-Logo.png\";\n"
				+"					}\n"
				+"				});\n"
				+"		}\n"
				+"		\n"
		...
		infoString.append("    <body onload=\"checkLogo()\">\n"
				+"        <div>\n"
				+"            <table style=\"text-align:center\">\n"
				+"                <tr>\n"
				+"                    <td style=\"width:150px\">\n"  
				+"						<img id=\"logo\" src=\"Custom-Logo.png\" alt=\"\" style=\"max-height:60px\">\n"
				+"  				  </td>\n"
				+"                    <td style=\"width:500px;height:60px\"><h1 >Aftershock Advisory and Forecast</h1></td>\n"
				+"					  </td>\n"
				+"                    <td style=\"width:150px\">\n"  
				+"						<img src=\"USAID-Logo.png\" alt=\"\" style=\"max-height:60px\">\n"
				+"  				  </td>\n"
				+"                </tr>\n"
				+"            </table>\n"
				+"            <br>\n"
		...
		probString.append("        <div style=\"width:800px;text-align:center;\">\n"
				...
				+"        </div>\n"
				+"\n"
				+"        <table style=\"width:650px;margin-left:50px;margin-right:100px\"><!-- Table of Probabilities -->\n"
				+"            <tr>\n"
				+"                <td>\n"
				+"                    <table>\n"
				+"                        <tr>\n"
				...
				+"                                    <tr>\n"
				+"                                        <!-- this should really be a variable number of magnitude bins -->\n"
		...
		keyString.append("               <td style=\"vertical-align:top\">\n"
				...
				+"                                    <th style=\"width:60px; font-weight:bold\">peak MMI</th>\n"
				+"                                    <th style=\"width:60px; font-weight:bold\">Potential Shaking</th>\n"
				+"                                    <th style=\"width:60px; font-weight:bold\">Potential Damage*</th>\n"
				+"                                </tr>\n"
				+"                                <tr>\n"
				...
				+"                        </td></tr>\n"
				+"                    </table>\n"
				+"						<p class=\"forecastKey\">*Damage may be higher in vulnerable structures</p>\n"
				+"                </td>\n"
				+"            </tr>\n"
				+"        </table>\n\n");
		...
		imgString.append(""
				+" 	<br>\n"
				+"	<div style=\"width:800px;height:550px;margin-left:0px;\">\n"
		);
		...
		if (shakeMapURL != null)
			imgString.append(" "
		        ...
		        +"			                   <br><p class=\"forecast\" style=\"white-space:pre\">Mainshock ShakeMap\n(previous shaking)</p>\n"
		        +"	        <img style=\"width:250px\" src=\"" + shakeMapURL + "\" alt=\"Mainshock shakemap\" id=\"shakemap\">\n"
		        +"	    </td>\n"
		        +"	    <td style=\"width:550px\">\n"
		        +"	            <img style=\"margin:auto;width:550px;max-height:480px\" src=\"numbermonth.png\" alt=\"Graphical Forecast\" id=\"theimage\">\n"
		        +"	        </td>\n"
		        +"	    </tr>\n"
		        +"	</table>\n"
			...
			imgString.append("		<img style=\"margin:auto;width:550px\" src=\"numbermonth.png\" alt=\"Graphical Forecast\" id=\"theimage\">\n"
			);
					
		imgString.append("		<div class=\"forecast\">\n"
				+"		This forecast will be updated as new information becomes available.\n"
				+"		</div>\n"
		);
		
		imgString.append("	</div>\n"
				+"\n"
				+"  <div style=\"margin-left:0px;width:800px;text-align:center\">\n"
				+"\n"
				+"	<input type=\"button\" class=\"activeImageButton\" value=\"Magnitude Distribution\" id=\"imageButton1\" onClick=\"changeImage('1');\">\n"
				+"	<input type=\"button\" class=\"imageButton\" value=\"Number with time\" id=\"imageButton2\" onClick=\"changeImage('2');\">\n"
				+"	<input type=\"button\" class=\"imageButton\" value=\"Aftershock rate map\" id=\"imageButton3\" onClick=\"changeImage('3');\">\n"
				+"\n"
				+"  </div>\n"
				+"  <div style=\"margin-left:0px;width:800px;text-align:center\">\n"
				+"\n"
				+"	<input type=\"button\" class=\"durButton\" value=\"Day\" id=\"durationButton1\" onClick=\"changeDuration('1');\">\n"
				+"	<input type=\"button\" class=\"durButton\" value=\"Week\" id=\"durationButton2\" onClick=\"changeDuration('2');\">\n"
				+"	<input type=\"button\" class=\"activeDurButton\" value=\"Month\" id=\"durationButton3\" onClick=\"changeDuration('3');\">\n"
				+"	<input type=\"button\" class=\"durButton\" value=\"Year\" id=\"durationButton4\" onClick=\"changeDuration('4');\">\n"
				+"\n"
				+"  </div>\n"
				+"\n"
				+"	<script>\n"
				...
				+"			image.src = imgName + '.png?modified=<? filemtime(\"' + imgName + '.png\")?>';\n"
				+"\n"
				+"			for (i = 1; i < 4; i++){\n"
				...
				+"				durNeeded = false;\n"
				+"			} else if (imgName.includes('Probability')){\n"
				+"				var imgtype = 'Probability';\n"
				+"				durNeeded = true;\n"
				+"			} else {\n"
	...
	public static void main(String[] args){
		...
		URL logoURL = GraphicalForecast.class.getResource(pngFile);
		if (logoURL != null){
			File logoFile = new File(logoURL.getFile());
			File destination = new File(System.getenv("HOME") + "/" + pngFile);

			try {
				FileUtils.copyFile(logoFile, destination);
			} catch (IOException e) {
							    e.printStackTrace();
				System.err.println("Couldn't copy: " + logoFile + " to file: " + destination);
			}
		} else {
