...
//	}
	...
	public void writeHTML(File outputFile){
		...
		headString.append(""
		        ...
		        +" 			}\n"
		        +"\n"
		        +" 			// scripts to check whether a custom logo has been added to the forecast directory\n"
				...
				+"\n"
				+"			function checkLogo(){\n"
				+"				checkImageExists(\"Custom-Logo.png\", function(existsImage) {\n"
				+"					if (existsImage == true) {\n"
				+"						//do nothing\n"
				+"					} else {\n"
		...
		infoString.append("    <body onload=\"checkLogo()\">\n"
				...
				+"						<img id=\"logo\" src=\"Custom-Logo.png\" alt=\"\" style=\"max-height:60px;max-width:150px\">\n"
				+"  				  </td>\n"
				+"                    <td style=\"width:500px;height:60px\"><h1 >Aftershock Advisory and Forecast</h1></td>\n"
				+"					  </td>\n"
				+"                    <td style=\"width:150px\">\n"  
				+"						<img src=\"USAID-Logo.png\" alt=\"\" style=\"max-height:60px;max-width:150px\">\n"
				+"  				  </td>\n"
				+"                </tr>\n"
				+"            </table>\n"
				+"            <br>\n"
		...
		if (shakeMapURL != null)
			imgString.append(" "
		        ...
		        +"	 				<!-- To manually specifiy the image you want to see displayed, replace 'numbermonth.png' with the desired filename. -->\n"
			...
			imgString.append(""
				+" 		<!-- To manually specifiy the image you want to see displayed, replace 'numbermonth.png' with the desired filename. -->\n"
				+" 		<img style=\"margin-right:0px;width:550px\" src=\"numbermonth.png\" alt=\"Graphical Forecast\" id=\"theimage\">\n"
			);
		...
		imgString.append(""
				...
				+"		<input type=\"button\" class=\"imageButton\" value=\"Shaking map\" id=\"imageButton3\" onClick=\"changeImage('3');\">\n"
				+"  </div>\n"
				+"\n"
				+"  <div style=\"margin-left:0px;width:800px;text-align:center\">\n"
