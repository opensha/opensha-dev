...
/**
 * This represents an ETAS aftershock model where the a-value distribution is the Bayesian
 ...
 *
 */
public class ETAS_AftershockModel_AICweighted extends ETAS_AftershockModel {
	 ...
	 * @return
	 */
	public static boolean areModelsEquivalent(ETAS_AftershockModel model1, ETAS_AftershockModel model2) {
	 ...
	 * @param model2
	 */
	public ETAS_AftershockModel_AICweighted(ETAS_AftershockModel model1, ETAS_AftershockModel model2) {
