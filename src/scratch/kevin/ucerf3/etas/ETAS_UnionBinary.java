...
public class ETAS_UnionBinary {

	public static void main(String[] args) throws ZipException, IOException {
		if (args.length < 3) {
			System.err.println("USAGE: "+ClassUtils.getClassNameWithoutPackage(ETAS_UnionBinary.class)
		...
		ETAS_CatalogIO.unionBinary(outputFile, inputFiles);
	}
