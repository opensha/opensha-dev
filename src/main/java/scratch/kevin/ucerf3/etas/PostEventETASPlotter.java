...
public class PostEventETASPlotter {
...
//		File binFile = new File(dir, "results.bin");
		...
		long ot = 1522956556000l;
		File binFile = new File(dir, "results.bin");
		String name = "Santa Cruz Island M5.3";
		TestScenario scenario = TestScenario.SANTA_CRUZ_M5p3;
		...
		if (scenario != null) {
			...
			ETAS_MultiSimAnalysisTools.plotScalesOfHazardChange(catalogs, null, scenario,
