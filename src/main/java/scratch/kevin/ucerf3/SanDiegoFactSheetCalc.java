...
public class SanDiegoFactSheetCalc {
	...
	public static void main(String[] args) throws ZipException, IOException, DocumentException {
		// copied this from bay area in order to do similar calcs for San Diego
		File outputDir = new File("/home/kevin/OpenSHA/UCERF3/san_diego_fact_sheet");
		...
		log_println(fw, "Calculation started using "+SanDiegoFactSheetCalc.class.getName()+" on "+new Date());
		
		File compoundFile = new File("/home/kevin/OpenSHA/UCERF3/2013_05_10-ucerf3p3-production-10runs_COMPOUND_SOL.zip");
		...
		if (do_branch_averaged) {
			...
			baSols.put(FaultModels.FM3_1, U3FaultSystemIO.loadSol(new File(
					"/home/kevin/OpenSHA/UCERF3/fss_csvs/2013_05_10-ucerf3p3-production-10runs_COMPOUND_SOL_FM3_1_MEAN_BRANCH_AVG_SOL.zip")));
			baSols.put(FaultModels.FM3_2, U3FaultSystemIO.loadSol(new File(
					"/home/kevin/OpenSHA/UCERF3/fss_csvs/2013_05_10-ucerf3p3-production-10runs_COMPOUND_SOL_FM3_2_MEAN_BRANCH_AVG_SOL.zip")));
		}
		...
		Region reg = new CaliforniaRegions.SAN_DIEGO_BOX();
