...
//		ReturnPeriods[] rps = ReturnPeriods.values();
		...
		File inputDirFull25 = new File(PRVI_Paths.INV_DIR, PRVI_Paths.COMBINED_DIR.getName()+"-ba_only-vs760");
		File inputDirCrustal25 = new File(PRVI_Paths.INV_DIR, PRVI_Paths.CRUSTAL_DIR.getName()+"-ba_only-vs760");
		File inputDirInterface25 = new File(PRVI_Paths.INV_DIR, PRVI_Paths.SUBDUCTION_DIR.getName()+"-ba_only-INTERFACE_only-vs760");
		File inputDirSlab25 = new File(PRVI_Paths.INV_DIR, PRVI_Paths.SUBDUCTION_DIR.getName()+"-ba_only-SLAB_only-vs760");
		File outputDir = new File(PRVI_Paths.COMBINED_DIR, "nshm03_erf_comparisons_"+imtDir);
		double sourceSpacing = 0.01;
		File sourcesDir03 = new File("/home/kevin/OpenSHA/nshm23/nshmp-haz-models/ext_hazard_calcs/"
				+ "prvi-t2-2003-ERF-2025-vB1-GMMs-2025conf-0p01-vs760-20241213-49f58ecb02d600/vs30-760/"+imtDir+"/source");
