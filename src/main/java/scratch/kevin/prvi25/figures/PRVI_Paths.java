...
public class PRVI_Paths {
	...
	public static final String MODEL_DATE = "2025_09_12";
	
	public static final File CRUSTAL_DIR = new File(INV_DIR, MODEL_DATE+"-prvi25_crustal_branches-dmSample10x");
	...
	public static final File SUBDUCTION_DIR = new File(INV_DIR, MODEL_DATE+"-prvi25_subduction_branches");
	...
	public static final File COMBINED_DIR = new File(INV_DIR, MODEL_DATE+"-prvi25_crustal_subduction_combined_branches");
