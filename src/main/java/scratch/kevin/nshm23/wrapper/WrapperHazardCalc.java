...
public class WrapperHazardCalc {
  ...
  public static void main(String[] args) throws IOException {
    ...
    NshmErf erf = new NshmErf(erfPath, false, false);
    ...
    // File outputDir = new
    // File("/home/kevin/OpenSHA/UCERF4/batch_inversions/2022_09_20-nshm18-hazard-ask2014/results");
    ...
    File outputDir = new File(
        "/home/kevin/OpenSHA/UCERF4/batch_inversions/2022_09_21-nshm18-ca-hazard-ask2014/results");
    Preconditions
        .checkState(outputDir.getParentFile().exists() || outputDir.getParentFile().mkdir());
