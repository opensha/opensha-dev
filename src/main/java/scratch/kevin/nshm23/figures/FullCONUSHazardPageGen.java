...
import static scratch.kevin.nshm23.figures.WUS_HazardChangePageGen.asLog10;
import static scratch.kevin.nshm23.figures.WUS_HazardChangePageGen.sumMap;
...
import scratch.kevin.nshm23.figures.WUS_HazardChangePageGen.ChangeStats;

public class FullCONUSHazardPageGen {
...
//		double period = 1d;
		...
		File nshm23HazardFile = new File("/home/kevin/OpenSHA/UCERF4/batch_inversions/"
				+ "2023_06_23-nshm23_branches-NSHM23_v2-CoulombRupSet-TotNuclRate-NoRed-ThreshAvgIterRelGR-ba_only-with_ceus/"
				+ "results_hazard_include_0.2deg.zip");
		GriddedGeoDataSet nshm23Hazard = MethodsAndIngredientsHazChangeFigures.loadXYZ(nshm23HazardFile, entryName);
		
		String parentPath = nshm23HazardFile.getParent();
		File outputDir = new File(parentPath.substring(0, parentPath.indexOf("-ba_only")), "hazard_comparisons_nshm18_conus_"+dirPrefix);
		
		File nshm23GridHazardFile = new File("/home/kevin/OpenSHA/UCERF4/batch_inversions/"
				+ "2023_06_23-nshm23_branches-NSHM23_v2-CoulombRupSet-TotNuclRate-NoRed-ThreshAvgIterRelGR-ba_only-with_ceus/"
				+ "results_hazard_only_0.2deg.zip");
...
//		GriddedGeoDataSet nshm23GridHazard = null;
		...
		File nshm18_23gridHazardFile = new File("/home/kevin/OpenSHA/UCERF4/batch_inversions/"
				+ "2023_07_10-nshm18-grid_src_from_23-conus-hazard-ask2014-0.2deg-noSub/results_hazard.zip");
