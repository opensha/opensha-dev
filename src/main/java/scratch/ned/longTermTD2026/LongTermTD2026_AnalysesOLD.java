 ...
 */
public class LongTermTD2026_AnalysesOLD {
...
//		double openInt = 0;
		...
		String stringForReadmeFile =
				...
				stringForReadmeFile += "\n This directory was generated by running the OpenSHA java method \n\n\tscratch.ned.longTermTD2026.longTermTD2026_AnalysesOLD.makeTestTD_CalculationFiles() \n\non "+dateString;
...
//		System.out.println("maxRatio="+(float)maxRatio);
	...
	private static void tempMakeTestTD_CalculationFilesForSingleSource() {
		...
		File outputDir2 = new File(outputDir1,"TD_TestFiles_1src");
		if(!outputDir2.exists()) outputDir2.mkdir();
		System.out.println(!outputDir2.exists()+"\t"+outputDir2);
...
//		double openInt = 0;
		double forecastDurationYears = 50;
		ProbabilityModelOptions probModel = ProbabilityModelOptions.U3_PREF_BLEND;
//		MagDependentAperiodicityOptions aperModel = MagDependentAperiodicityOptions.MID_VALUES;
...
//		int maxNumRups =0;
//		for(int s=0;s<erf.getNumFaultSystemSources();s++)
//			if(maxNumRups < erf.getSource(s).getNumRuptures())
//				maxNumRups = erf.getSource(s).getNumRuptures();
...
//		// test that sources have TectonicRegionType
//		FaultSystemSolutionERF erf = getFullPrefUS26_ERF();
